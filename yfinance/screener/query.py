...
class QueryBase(ABC):
    def __init__(
        self, operator: str, operand: Union[List["QueryBase"], Tuple[str, Tuple[Union[str, numbers.Real], ...]]]
    ):
    ...
    def to_dict(self) -> Dict:
        ...
        return {"operator": op, "operands": [o.to_dict() if isinstance(o, QueryBase) else o for o in ops]}
