...
class TickerBase:
    ...
    def get_news(self, count=200, tab="news", proxy=None) -> list:
        ...
        url = f"{_ROOT_URL_}/xhr/ncp?queryRef=latestNews&serviceKey=ncp_fin"
        payload = {
            "serviceConfig": {
                "snippetCount": count,  # 200 is the max returned
                "s": [self.ticker]
            }
        }
