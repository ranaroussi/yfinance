...
def download(tickers, start=None, end=None, actions=False, threads=True, ignore_tz=False,
             ...
             progress=True, period: utils.periods = "max", show_errors=True,
             interval: utils.intervals = "1d", prepost=False,
...
def _download_one_threaded(ticker, start=None, end=None,
                           ...
                           actions=False, progress=True, period: utils.periods = "max",
                           interval: utils.intervals = "1d", prepost=False, proxy=None,
...
def _download_one(ticker, start=None, end=None,
                  auto_adjust=False, back_adjust=False, repair=False,
                  actions=False, period: utils.periods = "max", interval: utils.intervals = "1m",
