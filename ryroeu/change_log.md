...
54. `confirmed that these known issues are fixed`: 2699
...
59. `confirmed that these known issues are fixed`: 2387
60. `confirmed that these known issues are fixed`: 2353
