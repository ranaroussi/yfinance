...
| 4 | Validate that the `quarterly_earnings` match expected positive value| Ticker is created | `quarterly_earnings` can handle positive values | `get_json` is updated | ✅ |
