...
class TestWebSocket(unittest.TestCase):
    """Verify live websocket message decoding."""

    def test_decode_message_valid(self):
        """Decode a valid base64 websocket payload."""
        message = (
        ...
        decoded = getattr(ws, "_decode_message")(message)
        ...
        expected = {
            ...
            'quote_type': 41,
            'market_hours': 1,
            'change_percent': 1.5344921,
            'day_volume': '59712028672',
            'day_high': 95227.555,
            'day_low': 92517.22,
            'change': 1431.8906,
            'open_price': 92529.99,
            'last_size': '59712028672',
            'price_hint': '2',
            'vol_24hr': '59712028672',
            'vol_all_currencies': '59712028672',
            'from_currency': 'BTC',
            'circulating_supply': 19808172.0,
    ...
    def test_decode_message_invalid(self):
        """Return structured error data for invalid payloads."""
        websocket = BaseWebSocket(Mock())
        base64_message = "invalid_base64_string"
        decoded = getattr(websocket, "_decode_message")(base64_message)
