...
class TestPriceHistory(unittest.TestCase):
    ...
    def test_dailyWithEvents(self):
        ...
        tkr_div_dates = {
            "BHP.AX": [_dt.date(2022, 9, 1), _dt.date(2022, 2, 24)],  # Yahoo claims 23-Feb but wrong because DST
    ...
    def test_dailyWithEvents_bugs(self):
        ...
        df_prices = _pd.DataFrame(
            data={c: [1.0] for c in yf.const._PRICE_COLNAMES_} | {"Volume": 0}, index=[div_dt + _dt.timedelta(days=1)]
        )
